function display_calendar(){
  ...
  display_date(first_date, last_date, year, month)
}

function display_date(first_date, last_date, year, month){
  process.stdout.write('1'.padStart(3 * first_date.getDay() + 2))
  display_suffix(first_date)
